# CLAUDE.md — G_Consultas

## Identity
This is the **G_Consultas** satellite project under the Antigravity ecosystem.
Domain: `01_HOSPITAL_PRIVADO`

Sistema de mapeo y consultas SQL para TrakCare/ALMA (InterSystems IRIS)
