# Tools_DataMover_Process.TrakResolveMaternityReferences
...
| MatLoadedGuids | varchar |  |  | SI | List of Guids loaded |
| PatienMatReferences | varchar |  |  | SI | List of patient Mother/Baby references |
| PatientDataToReloadFull | varchar |  |  | SI | - |
...
| TrakProcessGUID | varchar |  |  | SI | Trak process GUID for logging result on UI |
| TrakProcessLogIndex | integer |  |  | SI | - |
| TrakSessionID | varchar |  |  | SI | Trak session ID |
