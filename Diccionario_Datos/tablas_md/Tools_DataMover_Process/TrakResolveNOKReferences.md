# Tools_DataMover_Process.TrakResolveNOKReferences
...
| NOKLoadedGuids | varchar |  |  | SI | List of Guids loaded |
| PatienNOKReferences | varchar |  |  | SI | List of patient NOK references |
