# Tools_DataMover_Process.TrakResolvePatientCTReferences
...
| CodeTableLoadedGuids | varchar |  |  | SI | List of Guids loaded |
...
| PatienCTReferences | varchar |  |  | SI | List of patient code table references |
