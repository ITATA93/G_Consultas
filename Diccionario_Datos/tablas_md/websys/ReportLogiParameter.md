# websys.ReportLogiParameter

> Runtime parameter to pass to Logi to report execution
...
*Descripción original:* Runtime parameter to pass to Logi to report execution
