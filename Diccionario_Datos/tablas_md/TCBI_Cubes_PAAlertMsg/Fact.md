# TCBI_Cubes_PAAlertMsg.Fact

**Schema:** TCBI_Cubes_PAAlertMsg
**Columnas:** 41
...
Expression: %cube.Overri... |
| DxClosedFlag | bigint |  |  | SI | Dimension: DxClosedFlag
Expression: %cube.GetClos... |
| DxCreateHospital | bigint |  |  | SI | Dimension: DxCreateHospital<br/>
Source: ALMCreat... |
| DxErrorReason | bigint |  |  | SI | Dimension: DxErrorReason<br/>
Source: ALMErrorRea... |
| DxExpiryReason | bigint |  |  | SI | Dimension: DxExpiryReason<br/>
Source: ALMExpiryR... |
| DxPatientID | bigint |  |  | SI | Dimension: DxPatientID<br/>
Source: ALMPAPMIParRe... |
| DxSourceOfAlert | bigint |  |  | SI | Dimension: DxSourceOfAlert<br/>
Source: ALMSource... |
| RxIDViaALMPAPMIParRef | bigint |  |  | SI | Relationship: RxIDViaALMPAPMIParRef<br/>
Source: ... |
