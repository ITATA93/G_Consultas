...
| SEQ_CodeTableTags | varchar |  |  | SI | List of code table Tags |
| SEQ_Counter | double |  |  | SI | Counter |
| SEQ_CreatedDate | date |  |  | SI | Created Date |
| SEQ_CreatedTime | time |  |  | SI | Created Time |
| SEQ_CreatedUser_DR | bigint |  | FK | SI | Created User |
| SEQ_Desc | varchar |  |  | SI | Description |
| SEQ_Length | double |  |  | NO | Length |
| SEQ_Owner | varchar |  |  | SI | Owner |
| SEQ_Prefix | varchar |  |  | SI | Prefix |
| SEQ_Suffix | varchar |  |  | SI | Suffix |
| SEQ_UpdatedDate | date |  |  | SI | Updated Date |
| SEQ_UpdatedTime | time |  |  | SI | Updated Time |
| SEQ_UpdatedUser_DR | bigint |  | FK | SI | Updated User |
