# SQLUser.ARC_PayAgreemICDDiagCheckItem
...
|---------|------|----|----|----------|-------------|
| ITM_ParRef | varchar | PK |  | NO | ARC_PayAgreemICDDiagCheck Parent Reference |
...
| ITM_OrdCat_DR | bigint |  | FK | SI | Des Ref to OECOrderCategory |
| ITM_OrdSubCat_DR | bigint |  | FK | SI | Des Ref to Order SubCategory |
...
| Q01 | - |  |  | SI | Situación Familiar |
| Q02 | - |  |  | SI | Situación Económica |
| Q03 | - |  |  | SI | Vivienda |
| Q04 | - |  |  | SI | Relaciones Sociales |
| Q05 | - |  |  | SI | Apoyo Social |
