# SQLUser.LB_TestSetItemInterpretation
...
|---------|------|----|----|----------|-------------|
| LBTSII_ParRef | varchar | PK |  | NO | Parent TestSet DR |
| ChildQ01DR | - |  |  | SI | Child Reference: Registro de Eventos o Acontecimie... |
