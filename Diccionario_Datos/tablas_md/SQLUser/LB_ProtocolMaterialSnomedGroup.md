# SQLUser.LB_ProtocolMaterialSnomedGroup
...
|---------|------|----|----|----------|-------------|
| LBPMSG_ParRef | bigint | PK |  | NO | - |
| ChildQ01DR | - |  |  | SI | Child Reference: INSTRUMENTO DE CLASIFICACION DEL ... |
