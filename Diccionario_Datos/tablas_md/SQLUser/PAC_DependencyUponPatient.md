# SQLUser.PAC_DependencyUponPatient
...
|---------|------|----|----|----------|-------------|
| DEPPAT_RowId | bigint | PK |  | NO | - |
| DEPPAT_Code | varchar |  |  | NO | Code |
| DEPPAT_CodeTableTags | varchar |  |  | SI | List of code table Tags |
| DEPPAT_CreatedDate | date |  |  | SI | Created Date |
| DEPPAT_CreatedTime | time |  |  | SI | Created Time |
| DEPPAT_CreatedUser_DR | bigint |  | FK | SI | Created User |
| DEPPAT_DateFrom | date |  |  | SI | DateFrom |
| DEPPAT_DateTo | date |  |  | SI | DateTo |
| DEPPAT_Desc | varchar |  |  | NO | Description |
| DEPPAT_Owner | varchar |  |  | SI | Owner |
| DEPPAT_UpdatedDate | date |  |  | SI | Updated Date |
| DEPPAT_UpdatedTime | time |  |  | SI | Updated Time |
| DEPPAT_UpdatedUser_DR | bigint |  | FK | SI | Updated User |
| Q01 | - |  |  | SI | Date |
| Q02 | - |  |  | SI | Time |
| Q03 | - |  |  | SI | Side of symptomatic knee |
| Q04 | - |  |  | SI | If both knees will be operated on, please use a di... |
| Q05 | - |  |  | SI | Ethnicity |
| Q06 | - |  |  | SI | Please indicate the expected date and surgeon for ... |
| Q07 | - |  |  | SI | Date of operation |
| Q08 | - |  |  | SI | Surgeon |
| Q09 | - |  |  | SI | Will this be a primary or revision knee replacemen... |
...
| Q30 | - |  |  | SI | What do you expect to accomplish with your knee re... |
| Q31 | - |  |  | SI | Do you expect your knee joint replacement surgery ... |
| Q32 | - |  |  | SI | Do you expect your surgery will help you carry out... |
| Q33 | - |  |  | SI | Do you expect you surgery will help you perform le... |
