...
|---------|------|----|----|----------|-------------|
| NOTES_ParRef | bigint | PK |  | NO | MH_Detention Parent Reference |
| NOTES_Childsub | double |  |  | NO | Childsub |
| NOTES_CreateDate | date |  |  | SI | CreateDate |
| NOTES_CreateTime | time |  |  | SI | CreateTime |
| NOTES_CreateUser_DR | bigint |  | FK | SI | Des Ref SSUser |
| NOTES_Deleted | varchar |  |  | SI | Deleted |
