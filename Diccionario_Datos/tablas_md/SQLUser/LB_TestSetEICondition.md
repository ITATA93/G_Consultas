...
|---------|------|----|----|----------|-------------|
| LBTSEIC_ParRef | bigint | PK |  | NO | Parent TestSet DR |
| LBTSEIC_ElectronicIssueCondition_DR | bigint |  | FK | SI | Link to the system code table electronic issue con... |
| LBTSEIC_RowID | varchar |  |  | NO | - |
| Q01 | - |  |  | SI | Actividades Masivas: 1 condón por persona |
| Q02 | - |  |  | SI | Nombre Institución Responsable Actividad |
