...
|---------|------|----|----|----------|-------------|
| SCHED_ParRef | varchar | PK |  | NO | MRC_VendorItem Parent Reference |
| ChildQ02DR | - |  |  | SI | Child Reference: Cuidador 24 Horas |
...
| SCHED_Childsub | double |  |  | NO | Childsub |
...
| SCHED_Day | varchar |  |  | SI | Day |
| SCHED_RateType | varchar |  |  | SI | RateType |
| SCHED_RowId | varchar |  |  | NO | - |
| SCHED_TimeFrom | time |  |  | SI | TimeFrom |
| SCHED_TimeTo | time |  |  | SI | TimeTo |
