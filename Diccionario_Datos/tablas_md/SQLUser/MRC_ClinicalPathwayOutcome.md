# SQLUser.MRC_ClinicalPathwayOutcome
...
| Q001 | - |  |  | SI | Si se trata de envenenamiento y sus causas externa... |
| Q002 | - |  |  | SI | a) Identificar el producto: |
| Q003 | - |  |  | SI | b) Via de Ingreso (bucal, piel, etc.): |
| Q004 | - |  |  | SI | Lugar de obtención del producto: |
| Q005 | - |  |  | SI | d) Exámenes toxicológicos: |
| Q006 | - |  |  | SI | e) Consignarlas en el registro que realiza.: |
