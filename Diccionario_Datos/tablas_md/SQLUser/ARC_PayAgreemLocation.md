...
|---------|------|----|----|----------|-------------|
| LOC_ParRef | bigint | PK |  | NO | ARC_PaymentAgreement Parent Reference |
...
| LOC_Hospital_DR | bigint |  | FK | SI | Des Ref CT_Hospital |
...
| Q01 | - |  |  | SI | Grado - Disfunción - Descripción |
| Q02 | - |  |  | SI | Fecha Evaluación |
| Q03 | - |  |  | SI | Evaluador F.A. |
| Q04 | - |  |  | SI | Diagnósticos |
| Q05 | - |  |  | SI | Consideraciones referidas al paciente |
| Q06 | - |  |  | SI | Postura |
| Q07 | - |  |  | SI | Tipo de Alimentos |
| Q08 | - |  |  | SI | Cantidad en cada bocado |
| Q09 | - |  |  | SI | Tiempo de Alimentación |
| Q10 | - |  |  | SI | Autoalimentación |
