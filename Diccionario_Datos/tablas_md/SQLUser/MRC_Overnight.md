...
|---------|------|----|----|----------|-------------|
| OVERN_RowId | bigint | PK |  | NO | - |
| OVERN_Code | varchar |  |  | NO | Code |
| OVERN_CodeTableTags | varchar |  |  | SI | List of code table Tags |
| OVERN_CreatedDate | date |  |  | SI | Created Date |
| OVERN_CreatedTime | time |  |  | SI | Created Time |
| OVERN_CreatedUser_DR | bigint |  | FK | SI | Created User |
| OVERN_DateFrom | date |  |  | SI | Date From |
| OVERN_DateTo | date |  |  | SI | Date To |
| OVERN_Desc | varchar |  |  | NO | Description |
| OVERN_Owner | varchar |  |  | SI | Owner |
| OVERN_UpdatedDate | date |  |  | SI | Updated Date |
| OVERN_UpdatedTime | time |  |  | SI | Updated Time |
| OVERN_UpdatedUser_DR | bigint |  | FK | SI | Updated User |
