# SQLUser.ARC_PayAgreemOverrideBillGrp
...
|---------|------|----|----|----------|-------------|
| BG_ParRef | bigint | PK |  | NO | ARC_PaymentAgreement Parent Reference |
| BG_ARCIM_DR | varchar |  | FK | SI | Des Ref ARCIM |
| BG_BillGroup_DR | bigint |  | FK | SI | Des Ref BillGroup |
...
| Q04 | - |  |  | SI | La Escala de Rancho Los Amigos |
