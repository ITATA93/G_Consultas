# SQLUser.LBC_TestSetRevisionAddVerWKFL
...
|---------|------|----|----|----------|-------------|
| LBCTSRAVW_ParRef | bigint | PK |  | NO | - |
| ChildQ03DR | - |  |  | SI | Child Reference: Seguimiento del Plan de Intervenc... |
...
| LBCTSRAVW_Code | varchar |  |  | NO | Code |
...
| LBCTSRAVW_Desc | varchar |  |  | NO | Description |
