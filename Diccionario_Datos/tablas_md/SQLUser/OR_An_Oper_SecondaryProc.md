# SQLUser.OR_An_Oper_SecondaryProc
...
|---------|------|----|----|----------|-------------|
| SECPR_ParRef | varchar | PK |  | NO | OR_Anaest_Operation Parent Reference |
...
| SECPR_OutcomeOfSurgery_DR | bigint |  | FK | SI | Des Ref OutcomeOfSurgery |
