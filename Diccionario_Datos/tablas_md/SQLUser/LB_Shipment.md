...
|---------|------|----|----|----------|-------------|
| LBSH_RowID | bigint | PK |  | NO | - |
| LBSH_FromLabSite_DR | bigint |  | FK | SI | From Lab Site |
| LBSH_LastContainerIndex | varchar |  |  | SI | Last Container Index |
| LBSH_ShipmentNumber | varchar |  |  | SI | Packing Number |
| LBSH_Status | varchar |  |  | SI | Transaction Status of the Shipment |
| LBSH_ToLabSite_DR | bigint |  | FK | SI | To Lab Site  |
| LBSH_ToReferralLab_DR | bigint |  | FK | SI | Referral Lab Site |
...
| Q24 | - |  |  | SI | Presión Arteria Sistolica |
| Q24ObsDR | - |  |  | SI | Presión Arteria Sistolica DR |
| Q25 | - |  |  | SI | PA2 |
| Q25ObsDR | - |  |  | SI | PA2 DR |
| Q26 | - |  |  | SI | P |
| Q27 | - |  |  | SI | FR |
