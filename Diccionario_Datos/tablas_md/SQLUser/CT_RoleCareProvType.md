...
|---------|------|----|----|----------|-------------|
| CP_ParRef | bigint | PK |  | NO | CT_Role Parent Reference |
| CP_CareProvType_DR | bigint |  | FK | SI | Des Ref CareProvType |
...
| Q01 | - |  |  | SI | Technicians Comment |
| Q02 | - |  |  | SI | Quality of Effort |
| Q03 | - |  |  | SI | Forced Vital Capacity (FVC) |
| Q04 | - |  |  | SI | Forced Expiratory Volume (FEV) in 1 second (FEV1) |
| Q05 | - |  |  | SI | FEV1 / FVC |
| Q06 | - |  |  | SI | Bronchodilator response |
| Q07 | - |  |  | SI | Forced Expiratory Flow (FEF) 25 - 75% |
| Q08 | - |  |  | SI | Flow volume loop |
| Q09 | - |  |  | SI | Interpretation |
