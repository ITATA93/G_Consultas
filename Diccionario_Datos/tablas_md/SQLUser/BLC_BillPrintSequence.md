...
|---------|------|----|----|----------|-------------|
| BPS_RowId | bigint | PK |  | NO | - |
| BPS_BillGroup_DR | bigint |  | FK | SI | Des Ref BillGroup |
| BPS_CodeTableTags | varchar |  |  | SI | List of code table Tags |
| BPS_CreatedDate | date |  |  | SI | Created Date |
| BPS_CreatedTime | time |  |  | SI | Created Time |
| BPS_CreatedUser_DR | bigint |  | FK | SI | Created User |
| BPS_InsType_DR | bigint |  | FK | SI | Des Ref InsType |
| BPS_Owner | varchar |  |  | SI | Owner |
| BPS_Sequence | double |  |  | NO | Sequence |
| BPS_Summary | varchar |  |  | SI | Summary |
| BPS_UpdatedDate | date |  |  | SI | Updated Date |
| BPS_UpdatedTime | time |  |  | SI | Updated Time |
| BPS_UpdatedUser_DR | bigint |  | FK | SI | Updated User |
| Q01 | - |  |  | SI | Resultado |
