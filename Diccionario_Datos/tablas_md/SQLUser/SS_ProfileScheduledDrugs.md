# SQLUser.SS_ProfileScheduledDrugs
...
| SSSDC_MaxPrescDurUnit | varchar |  |  | SI | Maximum Prescribable Duration Unit |
| SSSDC_MaxPrescDurVal | integer |  |  | SI | Maximum Prescribable Duration |
