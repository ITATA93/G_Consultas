# SQLUser.LBC_TestItemAccreditation
...
|---------|------|----|----|----------|-------------|
| LBCTIA_ParRef | bigint | PK |  | NO | Parent TestItem DR |
| LBCTIA_Accreditation_DR | bigint |  | FK | SI | Accreditation |
| LBCTIA_CodeTableTags | varchar |  |  | SI | List of code table Tags |
| LBCTIA_CreatedDate | date |  |  | SI | Created Date |
| LBCTIA_CreatedTime | time |  |  | SI | Created Time |
| LBCTIA_CreatedUser_DR | bigint |  | FK | SI | Created User |
| LBCTIA_DateFrom | date |  |  | NO | Effective date for the record |
| LBCTIA_DateTo | date |  |  | SI | DateTo
Last day the record is active
Optional.  ... |
| LBCTIA_LabSiteList | varchar |  |  | SI | Location |
| LBCTIA_RowID | varchar |  |  | NO | - |
| LBCTIA_UpdatedDate | date |  |  | SI | Updated Date |
| LBCTIA_UpdatedTime | time |  |  | SI | Updated Time |
| LBCTIA_UpdatedUser_DR | bigint |  | FK | SI | Updated User |
...
| Q15 | - |  |  | SI | 4. Nome gusta andar con mi inhalador |
