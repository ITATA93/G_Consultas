# SQLUser.MRC_RiskEvalParamCriteria
...
|---------|------|----|----|----------|-------------|
| CRIT_ParRef | varchar | PK |  | NO | MRC_RiskEvalParam Parent Reference |
| CRIT_Childsub | double |  |  | NO | Childsub |
| CRIT_Code | varchar |  |  | NO | Code |
...
| CRIT_Desc | varchar |  |  | NO | Description |
...
| Q01 | - |  |  | SI | Presentó Reacción Adversa? |
| Q02 | - |  |  | SI | Tipo de Reacción |
| Q03 | - |  |  | SI | Otra reacción adversa |
| Q04 | - |  |  | SI | Se informó a Unidad de Medicina Transfusional |
