...
|---------|------|----|----|----------|-------------|
| CPW_ParRef | bigint | PK |  | NO | MRC_ICDDx Parent Reference |
| CPW_Childsub | double |  |  | NO | Childsub |
| CPW_ClinicalPathways_DR | bigint |  | FK | SI | Des Ref ClinicalPathways |
...
| Q01 | - |  |  | SI | MES |
| Q03 | - |  |  | SI | AÑO |
| Q04 | - |  |  | SI | Cartridge para Troponina |
| Q05 | - |  |  | SI | Cartridge Múltiple |
