...
|---------|------|----|----|----------|-------------|
| CURR_ParRef | bigint | PK |  | NO | AR_CloseShift Parent Reference |
| CURR_Balance | varchar |  |  | SI | Balance |
...
| Q08a | - |  |  | SI | Comentario Información Entregada por |
