...
Detalle de cada medicamento prescrito y administrado:
- Medicamento y dosis
...
**Campos clave:**
- MRMED_ParRef: Referencia al registro medico
- MRMED_Drug_DR: FK al medicamento
- MRMED_Dose: Dosis prescrita
- MRMED_Route_DR: Via de administracion
- MRMED_StartDate/EndDate: Periodo de tratamiento

## Columnas

| Columna | Tipo | PK | FK | Nullable | Descripcion |
|---------|------|----|----|----------|-------------|
| MED_ParRef | bigint | PK |  | NO | MR_Adm Parent Reference |
| CQ04 | - |  |  | SI | (null) |
| MED_AdminRoute_DR | bigint |  | FK | SI | Des Ref PHCAdministrationRoute |
| MED_Ceased | varchar |  |  | SI | Ceased |
| MED_Childsub | double |  |  | NO | Childsub |
| MED_Comments | varchar |  |  | SI | Comments |
...
| MED_Details | varchar |  |  | SI | Details |
| MED_DischComments | varchar |  |  | SI |  Discharge Comments |
...
| MED_ExternalMedDetails | varchar |  |  | SI | External Medication Details |
| MED_ExternalPrescriberDetails | varchar |  |  | SI | External Prescriber Details |
...
| MED_Indication | varchar |  |  | SI | Indication |
...
| MED_PRNIndication | varchar |  |  | SI | PRN Indication |
...
| Q01 | - |  |  | SI | Eye opening |
| Q02 | - |  |  | SI | Verbal response |
| Q03 | - |  |  | SI | Motor response |
| Q04 | - |  |  | SI | Age |
| Q05 | - |  |  | SI | Verbal response 2 to 5 years |
| Q06 | - |  |  | SI | Verbal response 0 to 23 month |
| Q07 | - |  |  | SI | 3 - 8: Severe brain injury |
| Q08 | - |  |  | SI | 9 - 12: Moderate brain injury |
| Q09 | - |  |  | SI | 13 - 15: Minor brain injury |
| Q10 | - |  |  | SI | The Glasgow Coma Scale is a neurological scale tha... |
| Q11 | - |  |  | SI | Date |
| Q12 | - |  |  | SI | Time |
| Q13 | - |  |  | SI | Score |
...
| Q16 | - |  |  | SI | 9 - 12 |
| Q17 | - |  |  | SI | 13 - 15 |
| Q18 | - |  |  | SI | Severe brain injury |
| Q19 | - |  |  | SI | Moderate brain injury |
| Q20 | - |  |  | SI | Minor brain injury |
