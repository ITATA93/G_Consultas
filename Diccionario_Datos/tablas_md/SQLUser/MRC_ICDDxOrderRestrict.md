# SQLUser.MRC_ICDDxOrderRestrict
...
|---------|------|----|----|----------|-------------|
| RESTR_ParRef | bigint | PK |  | NO | MRC_ICDDx Parent Reference |
| Q01 | - |  |  | SI | Tipo de Consulta |
| Q02 | - |  |  | SI | Profesional de Salud |
| Q04 | - |  |  | SI | ¿Asiste a consulta Programa Comercio Sexual? |
...
| RESTR_ARCIM_DR | varchar |  | FK | SI | Des Ref ARCIM |
...
| RESTR_DateFrom | date |  |  | SI | Date From |
| RESTR_DateTo | date |  |  | SI | Date To |
| RESTR_OrdCat_DR | bigint |  | FK | SI | Des Ref to OECOrderCategory |
| RESTR_OrdSubCat_DR | bigint |  | FK | SI | Des Ref to Order SubCategory |
