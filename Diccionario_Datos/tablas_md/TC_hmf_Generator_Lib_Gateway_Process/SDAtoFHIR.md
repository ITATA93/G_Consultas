# TC_hmf_Generator_Lib_Gateway_Process.SDAtoFHIR

**Schema:** TC_hmf_Generator_Lib_Gateway_Process
**Columnas:** 39
...
| EnabledDataSegments | varchar |  |  | SI | If none selected then all supported segments will ... |
| FHIRFormat | varchar |  |  | SI | The FHIR format to use for FHIR request message pa... |
| FHIRVersion | varchar |  |  | SI | FHIR Version |
...
| TransformClass | varchar |  |  | SI | API class to transform SDA To FHIR  |
