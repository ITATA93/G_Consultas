# Tools_DrugUpload_DURM.QueueHistory
...
| DRMQ_AcceptUser | varchar |  |  | NO | User (may contain "AUTO ACCEPT" not required real ... |
...
| DRMQ_HistDate | date |  |  | NO | History Entry Date  |
| DRMQ_HistRunRef | varchar |  |  | NO | Run that stores History |
| DRMQ_HistTime | time |  |  | NO | - |
