...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Accesos Venosos  |
| Q02 | varchar | PK |  | SI | Chequeo |
| Q03 | varchar | PK |  | SI | Inducción |
| Q04 | varchar | PK |  | SI | Sistema  |
| Q05 | varchar | PK |  | SI | Vía Aérea |
| Q06 | varchar | PK |  | SI | Ventilación |
| Q07 | varchar | PK |  | SI | Tipo Control |
| Q08 | bit | PK |  | SI | Periférico |
| Q09 | bit | PK |  | SI | Central |
| Q10 | numeric | PK |  | SI | N° (Periférico) |
| Q11 | numeric | PK |  | SI | N° (Central) |
| Q12 | varchar | PK |  | SI | Complejidad (Periférico)  |
| Q13 | varchar | PK |  | SI | Complejidad (Central)  |
| Q14 | varchar | PK |  | SI | Observaciones  |
| QANANO | varchar | PK |  | SI | ANANO |
