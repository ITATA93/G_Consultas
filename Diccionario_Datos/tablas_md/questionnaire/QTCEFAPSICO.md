...
| CQ9 | varchar | PK |  | SI | - |
| ID | bigint | PK |  | NO | - |
| Q1 | varchar | PK |  | SI | Estudios |
| Q10 | varchar | PK |  | SI | Conocimiento Diagnostico |
| Q11 | varchar | PK |  | SI | Creyente |
| Q12 | varchar | PK |  | SI | Red Social |
| Q13 | varchar | PK |  | SI | Actitud del Paciente |
| Q14 | varchar | PK |  | SI | Actitud de la familia |
| Q15 | varchar | PK |  | SI | Condicion del Paciente |
| Q2 | varchar | PK |  | SI | Diagnostico |
| Q3 | date | PK |  | SI | Fecha de Ingreso |
| Q4 | varchar | PK |  | SI | Actividad |
| Q5 | varchar | PK |  | SI | Hijos |
| Q6 | varchar | PK |  | SI | Foco Conflicto |
| Q7 | varchar | PK |  | SI | Evaluación Cognitiva |
| Q8 | varchar | PK |  | SI | Apgar Familiar |
| Q9 | varchar | PK |  | SI | Depresión |
