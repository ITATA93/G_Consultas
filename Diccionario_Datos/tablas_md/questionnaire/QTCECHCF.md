...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Motivo de Contención |
| Q02 | varchar | PK |  | SI | EV |
| Q04 | varchar | PK |  | SI | Efecto (Sedación) |
| Q05 | varchar | PK |  | SI | IM |
| Q06 | varchar | PK |  | SI | Tranquilizante |
| Q08Q1 | time | PK |  | SI | Horario Inicio |
| Q08Q2 | varchar | PK |  | SI | Tipo de Contencion |
| Q08Q3 | varchar | PK |  | SI | Estado Contencion |
| Q08Q4 | varchar | PK |  | SI | Estado Paciente |
| Q08Q5 | varchar | PK |  | SI | Control Medico |
| Q08Q6 | time | PK |  | SI | Hora Retiro Sujeciones |
