...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Objetivo de Aplicación del Cuestionario |
| Q02 | varchar | PK |  | SI | Aspecto |
| Q03 | varchar | PK |  | SI | Diametro |
| Q04 | varchar | PK |  | SI | Profundidad |
| Q05 | varchar | PK |  | SI | Cantidad Exudado |
| Q06 | varchar | PK |  | SI | Calidad Exudado |
| Q07 | varchar | PK |  | SI | Tejido esf/necrotico |
| Q08 | varchar | PK |  | SI | Tejido Granulatorio |
| Q09 | varchar | PK |  | SI | Edema |
| Q10 | varchar | PK |  | SI | Dolor |
| Q11 | varchar | PK |  | SI | Piel Circundante |
| Q12 | varchar | PK |  | SI | Puntaje |
| Q13 | varchar | PK |  | SI | Grado de la ulcera |
| Q14 | varchar | PK |  | SI | Agente Utilizado |
| Q15 | varchar | PK |  | SI | Aposito o Cobertura |
| Q16 | varchar | PK |  | SI | Tipo Fijacion |
| Q17 | varchar | PK |  | SI | Observaciones |
| Q18 | varchar | PK |  | SI | Localización NO |
| Q19 | varchar | PK |  | SI | Calidad Exudado |
| Q20 | varchar | PK |  | SI | Localización |
