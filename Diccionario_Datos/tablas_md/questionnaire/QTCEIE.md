...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Trae documentación |
| Q02 | varchar | PK |  | SI | Observaciones |
| Q03 | varchar | PK |  | SI | Cuál(es) |
| Q04 | varchar | PK |  | SI | Observaciones |
| Q05 | varchar | PK |  | SI | Trae medicamentos de uso habitual |
| Q06 | varchar | PK |  | SI | Observaciones |
| Q07 | varchar | PK |  | SI | Cuál(es) |
| Q08 | varchar | PK |  | SI | Observaciones |
| Q09 | varchar | PK |  | SI | Trae otras pertenecias  |
| Q10 | varchar | PK |  | SI | Observaciones |
| Q11 | varchar | PK |  | SI | Cuál(es) |
| Q12 | varchar | PK |  | SI | Observaciones |
| Q13 | varchar | PK |  | SI | Observaciones de enfermeria |
