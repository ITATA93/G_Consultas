...
| QEMBRION | varchar | PK |  | SI | Embrion |
...
| QLCF1 | varchar | PK |  | SI | Latidos Cardio Fetales |
| QLCN | varchar | PK |  | SI | Longitud Cefalo-Nalgas |
| QLOC | varchar | PK |  | SI | Localización |
| QLPM | varchar | PK |  | SI | LPM |
| QObs | varchar | PK |  | SI | Observación |
| QSACO | varchar | PK |  | SI | Saco amniotico |
| QSACOVITE | varchar | PK |  | SI | Saco Vitelino |
