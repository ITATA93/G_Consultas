...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| QIDM10 | varchar | PK |  | SI | Nombre |
| QIDM11 | varchar | PK |  | SI | RUT |
| QIDP01 | varchar | PK |  | SI | Ficha o DAU |
| QIDP02 | varchar | PK |  | SI | Diagnóstico |
| QIDP03 | bit | PK |  | SI | Paciente |
| QIDP04 | bit | PK |  | SI | Familiar |
| QIDP05 | bit | PK |  | SI | Representante Legal |
| QIDP06 | bit | PK |  | SI | Aceptar Participación de Estudiante |
| QIDP07 | bit | PK |  | SI | No Aceptar Participación de Estudiante |
| QIDP08 | bit | PK |  | SI | ACEPTO |
| QIDP09 | bit | PK |  | SI | NO ACEPTO |
