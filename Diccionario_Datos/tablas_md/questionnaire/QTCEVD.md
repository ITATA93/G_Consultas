...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | bit | PK |  | SI | Médico |
| Q02 | varchar | PK |  | SI | Diagnóstico |
| Q03 | numeric | PK |  | SI | PA |
| Q04 | numeric | PK |  | SI | SAT |
| Q05 | numeric | PK |  | SI | Pulso |
| Q06 | numeric | PK |  | SI | T° |
| Q07 | varchar | PK |  | SI | Apetito |
| Q08 | varchar | PK |  | SI | Nauseas |
| Q09 | varchar | PK |  | SI | Vómitos |
| Q10 | varchar | PK |  | SI | Cansancio |
| Q11 | varchar | PK |  | SI | Somnolencia |
| Q12 | varchar | PK |  | SI | Deposiciones |
| Q13 | varchar | PK |  | SI | Otros |
| Q14 | varchar | PK |  | SI | Comentarios |
| Q15 | bit | PK |  | SI | Enfermera |
| Q16 | bit | PK |  | SI | Psicólogo |
| Q17 | bit | PK |  | SI | Técnico Paramédico |
| Q18 | varchar | PK |  | SI | Eva Dolor |
| Q19 | varchar | PK |  | SI | Dif. Dormir |
| Q20 | varchar | PK |  | SI | Continencia |
| Q21 | varchar | PK |  | SI | Angustia |
