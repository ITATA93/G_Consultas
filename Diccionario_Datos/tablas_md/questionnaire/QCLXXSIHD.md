...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Nombre del Paciente |
| Q02 | varchar | PK |  | SI | Apellido Paterno |
| Q03 | varchar | PK |  | SI | Apellido Materno |
| Q04 | varchar | PK |  | SI | RUN |
| Q05 | varchar | PK |  | SI | Edad |
| Q06 | varchar | PK |  | SI | Dirección |
| Q07 | varchar | PK |  | SI | Número |
| Q08 | varchar | PK |  | SI | Nombre del Cuidados |
