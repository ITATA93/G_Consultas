...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Es impulsivo, irritable |
| Q02 | varchar | PK |  | SI | Es llorón(a) |
| Q03 | varchar | PK |  | SI | Es más movido de lo normal |
| Q04 | varchar | PK |  | SI | No puede estar quieto/a |
| Q05 | varchar | PK |  | SI | Es destructor (ropas, juguetes, otros objetos) |
| Q06 | varchar | PK |  | SI | No acaba las cosas que empieza |
| Q07 | varchar | PK |  | SI | Se distrae fácilmente, tiene escasa atención |
| Q08 | varchar | PK |  | SI | Cambia bruscamente sus estados de ánimo |
| Q09 | varchar | PK |  | SI | Sus esfuerzos se frustran fácilmente |
| Q10 | varchar | PK |  | SI | Suele molestar frecuentemente a otros niños |
| Q11 | varchar | PK |  | SI | Resultado Test de Conners para padres |
| Q11ObsDR | varchar | PK | FK | SI | Resultado Test de Conners para padres DR |
