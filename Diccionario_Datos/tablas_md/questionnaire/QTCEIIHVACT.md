...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | date | PK |  | SI | Fecha Actual |
| Q02 | varchar | PK |  | SI | ¿Paciente con Infección previa a Procedimiento Inv... |
| Q03 | varchar | PK |  | SI | ¿Paciente con Infección previa a Procedimiento Inv... |
| Q04 | varchar | PK |  | SI | ¿Procedimientos invasivos In Situ? |
| Q05 | varchar | PK |  | SI | ¿Procedimientos invasivos In Situ? observaciones |
| Q06 | varchar | PK |  | SI | ¿Se indicó Terapia Antimicrobiana? |
| Q07 | varchar | PK |  | SI | ¿Se indicó Terapia Antimicrobiana? Observaciones |
| Q08 | varchar | PK |  | SI | ¿Se indicó Cambio en terapia Antimicrobiano? |
| Q09 | varchar | PK |  | SI | ¿Se indicó Cambio en terapia Antimicrobiano? obser... |
| Q10 | varchar | PK |  | SI | ¿Presenta Evidencia Clínica de IAAS? |
| Q11 | varchar | PK |  | SI | ¿Presenta Evidencia Clínica de IAAS observaciones |
| Q12 | varchar | PK |  | SI | ¿Exámenes de Laboratorio solicitados? |
| Q13 | varchar | PK |  | SI | ¿Exámenes de Laboratorio solicitados? observacione... |
| Q14 | varchar | PK |  | SI | ¿Paciente con cirugía indicador de IIH? |
| Q15 | varchar | PK |  | SI | ¿Paciente con cirugía indicador de IIH? observacio... |
| Q16 | varchar | PK |  | SI | ¿Cuál? |
| Q17 | varchar | PK |  | SI | ¿Caso IIH Confirmado? |
| Q18 | varchar | PK |  | SI | ¿Caso IIH Confirmado? ¿Cual? |
| Q19 | varchar | PK |  | SI | Otro |
| Q20 | varchar | PK |  | SI | Otro (Especificar) |
| Q21 | date | PK |  | SI | Fecha IIH |
| Q22 | varchar | PK |  | SI | Nombre de Microorganismo |
| Q23 | varchar | PK |  | SI | Nombre de Microorganismo Otro (Especificar) |
| Q24 | varchar | PK |  | SI | Acciones |
| Q25 | varchar | PK |  | SI | Nombre de Enfermera IAAS |
