...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01Q1 | varchar | PK |  | SI | Examen de Laboratorio |
| Q01Q2 | date | PK |  | SI | Fecha de realización |
| Q01Q3 | varchar | PK |  | SI | Resultado |
| Q01Q4 | varchar | PK |  | SI | Comentario |
