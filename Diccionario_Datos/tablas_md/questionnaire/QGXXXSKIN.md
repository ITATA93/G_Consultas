...
*Descripción original:* Skin Examination
...
| Q06 | varchar |  |  | SI | Petechiae |
| Q06N | varchar |  |  | SI | Note |
| Q06ObsDR | varchar |  | FK | SI | Petechiae DR |
| Q07 | varchar |  |  | SI | Oedema |
| Q07N | varchar |  |  | SI | Note |
| Q07ObsDR | varchar |  | FK | SI | Oedema DR |
| Q08 | varchar |  |  | SI | Surgical scars |
| Q08N | varchar |  |  | SI | Note |
| Q08ObsDR | varchar |  | FK | SI | Surgical scars DR |
| Q09 | varchar |  |  | SI | Wounds |
| Q09D | varchar |  |  | SI | Dressing |
| Q09L | varchar |  |  | SI | Location |
| Q09ObsDR | varchar |  | FK | SI | Wounds DR |
| Q10 | varchar |  |  | SI | Burns |
| Q10G | varchar |  |  | SI | Burns degree |
| Q10L | varchar |  |  | SI | Note / Location |
...
| Q27 | varchar |  |  | SI | Liquide volumn |
| Q27ObsDR | varchar |  | FK | SI | Liquide volumn DR |
...
| Q32 | varchar |  |  | SI | Enteral Nutrition (NE) |
| Q32N | varchar |  |  | SI | Note |
| Q32ObsDR | varchar |  | FK | SI | Enteral Nutrition (NE) DR |
| Q34 | varchar |  |  | SI | Parenteral nutrition (TPN) |
| Q34N | varchar |  |  | SI | Note |
| Q34ObsDR | varchar |  | FK | SI | Parenteral nutrition (TPN) DR |
...
| Q50 | varchar |  |  | SI | Purpura |
| Q50N | varchar |  |  | SI | Note |
| Q50ObsDR | varchar |  | FK | SI | Purpura DR |
| Q52 | varchar |  |  | SI | Rash |
| Q52N | varchar |  |  | SI | Note |
| Q52ObsDR | varchar |  | FK | SI | Rash DR |
| Q54 | varchar |  |  | SI | Skin Lesions |
| Q54N | varchar |  |  | SI | Note |
| Q54ObsDR | varchar |  | FK | SI | Skin Lesions DR |
| Q56 | bigint |  |  | SI | Remarks |
| Q56TxtOnly | bigint |  |  | SI | Remarks Plain Text Only |
| Q57 | varchar |  |  | SI | Hair |
| Q57N | varchar |  |  | SI | Note |
| Q59 | varchar |  |  | SI | Nails |
| Q59N | varchar |  |  | SI | Note |
| Q61 | varchar |  |  | SI | Hair Texture |
| Q61N | varchar |  |  | SI | Note |
| Q61ObsDR | varchar |  | FK | SI | Hair Texture DR |
| Q63 | varchar |  |  | SI | Alopecia |
| Q63N | varchar |  |  | SI | Note |
| Q63ObsDR | varchar |  | FK | SI | Alopecia DR |
| Q65 | varchar |  |  | SI | Male pattern hair loss |
| Q65N | varchar |  |  | SI | Note |
| Q65ObsDR | varchar |  | FK | SI | Male pattern hair loss DR |
| Q67 | varchar |  |  | SI | Peripheral cyanosis |
| Q67N | varchar |  |  | SI | Note |
| Q67ObsDR | varchar |  | FK | SI | Peripheral cyanosis DR |
| Q69 | varchar |  |  | SI | Pallor |
| Q69N | varchar |  |  | SI | Note |
| Q69ObsDR | varchar |  | FK | SI | Pallor DR |
| Q71 | varchar |  |  | SI | Clubbing |
| Q71N | varchar |  |  | SI | Note |
| Q71ObsDR | varchar |  | FK | SI | Clubbing DR |
| Q73 | varchar |  |  | SI | Beau’s lines |
| Q73N | varchar |  |  | SI | Note |
| Q73ObsDR | varchar |  | FK | SI | Beau’s lines DR |
| Q75 | varchar |  |  | SI | Paronychia |
| Q75N | varchar |  |  | SI | Note |
| Q75ObsDR | varchar |  | FK | SI | Paronychia DR |
| Q77 | varchar |  |  | SI | Onycholysis |
| Q77N | varchar |  |  | SI | Note |
| Q77ObsDR | varchar |  | FK | SI | Onycholysis DR |
| Q79 | varchar |  |  | SI | Nail pitting |
| Q79N | varchar |  |  | SI | Note |
| Q79ObsDR | varchar |  | FK | SI | Nail pitting DR |
| Q81 | varchar |  |  | SI | Nail discolouration |
| Q81N | varchar |  |  | SI | Note |
| Q81ObsDR | varchar |  | FK | SI | Nail discolouration DR |
| Q83 | varchar |  |  | SI | Other Notes |
| Q84 | date |  |  | SI | Date |
| Q85 | time |  |  | SI | Time |
