...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | 1. ¿Cómo está tu asma hoy? |
| Q02 | varchar | PK |  | SI | 2. ¿Qué tan problemática es tu asma cuando corres,... |
| Q03 | varchar | PK |  | SI | 3. ¿Tienes tos debido a tu asma? |
| Q04 | varchar | PK |  | SI | 4. ¿Te despiertas durante la noche debido a tu asm... |
| Q05 | varchar | PK |  | SI | 5. Durante las últimas 4 semanas, ¿Cuántos días tu... |
| Q06 | varchar | PK |  | SI | 6. Durante las últimas 4 semanas, ¿Cuántos días tu... |
| Q07 | varchar | PK |  | SI | 7. Durante las últimas 4 semanas, ¿Cuántos días se... |
| Q08 | varchar | PK |  | SI | Resultado Asma Infancia |
| Q08ObsDR | varchar | PK | FK | SI | Resultado Asma Infancia DR |
