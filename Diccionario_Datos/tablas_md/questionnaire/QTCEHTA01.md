...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Anamnesis Próxima / Motivo de Ingreso |
| Q02 | varchar | PK |  | SI | Examen Físico de Ingreso |
| Q03 | varchar | PK |  | SI | Plan de Ingreso |
