...
| CQ10 | varchar | PK |  | SI | - |
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Un miembro de la familia ha tenido problemas emoci... |
| Q02 | varchar | PK |  | SI | Un miembro de la familia ha tenido problemas con e... |
| Q03 | varchar | PK |  | SI | Aumento de discusiones entre padres e hijos |
| Q04 | varchar | PK |  | SI | Aumento de conflictos entre los hijos |
| Q05 | varchar | PK |  | SI | Aumento de desacuerdos en torno a las actividades ... |
| Q06 | varchar | PK |  | SI | Aumento del número de problemas o asuntos que qued... |
| Q07 | varchar | PK |  | SI | Aumento de las tareas sin hacer |
| Q08 | varchar | PK |  | SI | Aumento de los conflictos con las familias de orig... |
| Q09 | varchar | PK |  | SI | Total |
| Q10 | varchar | PK |  | SI | Total Test |
