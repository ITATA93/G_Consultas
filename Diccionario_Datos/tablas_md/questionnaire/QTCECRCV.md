...
| CQ8 | varchar | PK |  | SI | - |
| ID | bigint | PK |  | NO | - |
| Q1 | varchar | PK |  | SI | Edad y sexo |
| Q2 | varchar | PK |  | SI | Antecedentes personales de enfermedad cardiovascul... |
| Q3 | varchar | PK |  | SI | Antecedentes familiares de enfermedad cardiovascul... |
| Q4 | varchar | PK |  | SI | ¿Usted fuma? |
| Q5 | varchar | PK |  | SI | ¿Tiene hipertensión arterial? |
| Q6 | varchar | PK |  | SI | ¿Tiene diabetes mellitus? |
| Q7 | varchar | PK |  | SI | Colesterol Total >= 200 mg/dl |
| Q8 | varchar | PK |  | SI | ¿Tiene enfermedad vascular ateroesclerótica? |
...
| Qqr | varchar | PK |  | SI | Resultado Riesgo Cardiovascular |
