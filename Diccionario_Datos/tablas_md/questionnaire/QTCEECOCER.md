...
| QCONCLUSION | varchar | PK |  | SI | Conclusión |
| QCONCLUSION8 | varchar | PK |  | SI | Hipótesis Diagnóstica |
| QCPF | varchar | PK |  | SI | Con presión Fundida |
| QEGEST | varchar | PK |  | SI | Edad gestacional |
| QEGESTREAL | varchar | PK |  | SI | Edad Gestacional Real |
| QFECHAEXAMEN | date | PK |  | SI | Fecha Examen |
| QFUNNELING | varchar | PK |  | SI | Funneling |
| QFUR | date | PK |  | SI | Fecha Última Regla |
| QObs | varchar | PK |  | SI | Observaciones |
| QSLUDGE | varchar | PK |  | SI | Sludge |
