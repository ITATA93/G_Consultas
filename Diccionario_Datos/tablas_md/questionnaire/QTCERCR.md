...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Gravedad asociada al pronóstico |
| Q02 | varchar | PK |  | SI | Grado de Discapacidad |
| Q03 | varchar | PK |  | SI | Grado de Protección Social |
| Q04 | varchar | PK |  | SI | Edad |
| Q05 | varchar | PK |  | SI | Disponibilidad |
