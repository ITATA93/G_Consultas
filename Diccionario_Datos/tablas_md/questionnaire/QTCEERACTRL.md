...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | ¿Ha despertado por asma? |
| Q02 | varchar | PK |  | SI | ¿Ha requerido una dosis mayor de BD que la habitua... |
| Q03 | varchar | PK |  | SI | ¿Le ha impedido el asma, desarrollar sus actividad... |
| Q04 | varchar | PK |  | SI | ¿Ha debido efectuar visitas médicas no programadas... |
| Q05 | varchar | PK |  | SI | ¿Percibe Ud. que el nivel de control del asma no e... |
| QRPCA | varchar | PK |  | SI | Resultado Puntaje Control Asma |
| QRPCAObsDR | varchar | PK | FK | SI | Resultado Puntaje Control Asma DR |
