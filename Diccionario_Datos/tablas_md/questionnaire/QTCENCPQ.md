...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | N° episodio |
| Q02 | date | PK |  | SI | FECHA |
| Q03 | time | PK |  | SI | HORA |
| Q04 | varchar | PK |  | SI | Intervención quirúrgica programada |
| Q05 | varchar | PK |  | SI | Se aplicó lista de chequeo quirúrgico al paciente? |
| Q06 | varchar | PK |  | SI | Tuvo alguna consecuencia para el paciente? |
| Q07 | bit | PK |  | SI | No causó daño pero precisó monitorización |
| Q08 | bit | PK |  | SI | Causó daño y precisó tratamiento o intervención in... |
| Q09 | varchar | PK |  | SI | Otras |
| Q10 | varchar | PK |  | SI | En que etapa del proceso ocurrió el incidente? |
| Q11 | varchar | PK |  | SI | Tipo de incidente |
| Q12 | varchar | PK |  | SI | Otros |
| Q13 | varchar | PK |  | SI | Sugiere alguna recomendación para evitar este inci... |
| Q14 | varchar | PK |  | SI | Breve descripción del incidente y efectos: |
