...
| CQ15 | varchar | PK |  | SI | - |
| CQAV | varchar | PK |  | SI | - |
| CQConfDiag | varchar | PK |  | SI | - |
| CQEM | varchar | PK |  | SI | - |
| CQPC | varchar | PK |  | SI | - |
| CQSERec | varchar | PK |  | SI | - |
| CQTBC | varchar | PK |  | SI | - |
| ID | bigint | PK |  | NO | - |
| Q12 | date | PK |  | SI | Fecha ultima dosis |
| Q13 | numeric | PK |  | SI | Numero dosis |
| Q15 | varchar | PK |  | SI | Lugar de Contagio |
| QAV | varchar | PK |  | SI | Antecedente Vacunación |
| QConfDiag | varchar | PK |  | SI | Confirmación Diagnóstica |
| QConfiDiag | varchar | PK |  | SI | Confirmación Diagnóstica |
| QEM | varchar | PK |  | SI | Embarazo |
| QEX | varchar | PK |  | SI | Pais de contagio |
| QFPS | date | PK |  | SI | Fecha Primeros Síntomas |
| QOF | varchar | PK |  | SI | Oficina Provincial |
| QPC | varchar | PK |  | SI | Lugar de Contagio |
| QSE | varchar | PK |  | SI | Seremi |
| QSERec | varchar | PK |  | SI | SE Recaída |
| QSG | varchar | PK |  | SI | Semanas de Gestación |
| QTBC | varchar | PK |  | SI | En Caso de TBC |
