...
|---------|------|----|----|----------|-------------|
| CQ11ADT1 | varchar | PK |  | SI | - |
| ID | bigint | PK |  | NO | - |
| Q01ADT1 | varchar | PK |  | SI | Esp_Codigo |
| Q02ADT1 | date | PK |  | SI | Fecha del Accidente |
| Q03ADT1 | varchar | PK |  | SI | Lugar del Accidente |
| Q04ADT1 | varchar | PK |  | SI | RUN del Empleador |
| Q05ADT1 | varchar | PK |  | SI | Nombre del Empleador |
| Q06ADT1 | varchar | PK |  | SI | Telefono del Empleador |
| Q07ADT1 | varchar | PK |  | SI | Dirección del Empleador |
| Q08ADT1 | varchar | PK |  | SI | Area del Empleador |
| Q09ADT1 | varchar | PK |  | SI | Comuna del Empleador |
| Q10ADT1 | varchar | PK |  | SI | Nombre del Funcionario |
| Q11ADT1 | varchar | PK |  | SI | Protegido |
| Q12ADT1 | varchar | PK |  | SI | INP |
| Q13ADT1 | time | PK |  | SI | Hora |
