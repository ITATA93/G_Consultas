...
| CQ9 | varchar | PK |  | SI | - |
| ID | bigint | PK |  | NO | - |
| Q1 | varchar | PK |  | SI | ¿Tiene úlcera activa en el pie? |
| Q10 | varchar | PK |  | SI | Otros elementos a considerar |
| Q2 | varchar | PK |  | SI | ¿Amputación previa o úlcera cicatrizada? |
| Q3 | varchar | PK |  | SI | Deformidad del pie |
| Q4 | varchar | PK |  | SI | Hiperqueratosis |
