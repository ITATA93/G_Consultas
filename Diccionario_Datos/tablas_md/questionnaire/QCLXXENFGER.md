# questionnaire.QCLXXENFGER

> Ingreso de Enfermería Ambulatorio Geriatría
...
*Descripción original:* Ingreso de Enfermería Ambulatorio Geriatría
...
| Q10a | varchar |  |  | SI | Procedencia Otro Centro Asistencial |
...
| Q136 | varchar |  |  | SI | Comentario GLPP |
| Q137 | varchar |  |  | SI | Comentario ULPP |
| Q138 | varchar |  |  | SI | Comentario LLPP |
| Q139 | varchar |  |  | SI | Origen LPP |
| Q139ObsDR | varchar |  | FK | SI | Origen LPP DR |
| Q13a | varchar |  |  | SI | Antecedentes Clínicos |
| Q140 | varchar |  |  | SI | Comentario OLPP |
...
| Q172 | varchar |  |  | SI | Médico Tratante |
| Q173 | varchar |  |  | SI | Tratamiento Oncologíco Actual |
| Q175 | varchar |  |  | SI | Comentarios |
| Q176 | varchar |  |  | SI | Caso clínico presentado a Comité Oncológico |
| Q177 | date |  |  | SI | Fecha del Comité |
| Q178 | varchar |  |  | SI | Consentimiento Informado Firmado (Inicio Quimioter... |
| Q179 | date |  |  | SI | Fecha de la firma de consentimiento  |
| Q17a | varchar |  |  | SI | Dispositivos Artificiales |
| Q180 | varchar |  |  | SI | Pase Dental |
| Q181 | varchar |  |  | SI | Comentarios Pase Dental  |
| Q182 | varchar |  |  | SI | Idioma Nativo |
| Q183 | varchar |  |  | SI | Percepción de Redes de Apoyo |
| Q184 | varchar |  |  | SI | ECOG |
| Q184ObsDR | varchar |  | FK | SI | ECOG DR |
| Q186 | varchar |  |  | SI | Estado de Piel y Mucosas |
| Q186ObsDR | varchar |  | FK | SI | Estado de Piel y Mucosas DR |
| Q187 | varchar |  |  | SI | Ojos |
| Q187ObsDR | varchar |  | FK | SI | Ojos DR |
| Q188 | varchar |  |  | SI | Nariz |
| Q188ObsDR | varchar |  | FK | SI | Nariz DR |
| Q189 | varchar |  |  | SI | Aleteo Nasal |
| Q189ObsDR | varchar |  | FK | SI | Aleteo Nasal DR |
| Q18a | varchar |  |  | SI | Otro Dispositivo |
| Q190 | varchar |  |  | SI | Boca |
| Q190ObsDR | varchar |  | FK | SI | Boca DR |
| Q191 | varchar |  |  | SI | Deglución |
| Q191ObsDR | varchar |  | FK | SI | Deglución DR |
| Q192 | varchar |  |  | SI | Oídos |
| Q192ObsDR | varchar |  | FK | SI | Oídos DR |
| Q193 | varchar |  |  | SI | Retracción |
| Q193ObsDR | varchar |  | FK | SI | Retracción DR |
| Q194 | varchar |  |  | SI | Dorso |
| Q194ObsDR | varchar |  | FK | SI | Dorso DR |
| Q195 | varchar |  |  | SI | RFM OD |
| Q195ObsDR | varchar |  | FK | SI | RFM OD DR |
| Q196 | varchar |  |  | SI | RFM OI |
| Q196ObsDR | varchar |  | FK | SI | RFM OI DR |
| Q197 | varchar |  |  | SI | R. Corneal OD |
| Q197ObsDR | varchar |  | FK | SI | R. Corneal OD DR |
| Q198 | varchar |  |  | SI | R. Corneal OI |
| Q198ObsDR | varchar |  | FK | SI | R. Corneal OI DR |
| Q199 | varchar |  |  | SI | Etapas de envejecimiento reproductivo |
| Q200 | varchar |  |  | SI | Anticoncepción |
| Q201 | varchar |  |  | SI | Comentarios Piel M |
| Q202 | varchar |  |  | SI | Comentaros Ojos |
| Q203 | varchar |  |  | SI | Comentarios Nariz |
| Q204 | varchar |  |  | SI | Comentarios Aleteo N |
| Q205 | varchar |  |  | SI | Comentarios Boca |
| Q206 | varchar |  |  | SI | Comentario Deglución |
| Q207 | varchar |  |  | SI | Comentario Oídos |
| Q208 | varchar |  |  | SI | Comentario Retracción |
| Q209 | varchar |  |  | SI | Comentario Dorso |
| Q20a | varchar |  |  | SI | Otro Dispositivo Clínico |
| Q210 | varchar |  |  | SI | Comentario RFM OD |
| Q211 | varchar |  |  | SI | Comentario RFM OI |
| Q212 | varchar |  |  | SI | Cmentario R. Corneal OD |
| Q213 | varchar |  |  | SI | Comentario R. Corneal OI |
| Q214 | varchar |  |  | SI | Comentario Etapas Enve Repro |
| Q215 | varchar |  |  | SI | Comentario Anticoncepción |
| Q216 | varchar |  |  | SI | Criopreservación (Hombre) |
| Q217 | varchar |  |  | SI | Comentarios Crio |
| Q218 | varchar |  |  | SI | Paciente Reside con |
| Q219 | varchar |  |  | SI | Comentarios Reside con |
| Q21a | varchar |  |  | SI | Exámenes que Trae el Paciente |
| Q220 | varchar |  |  | SI | Derivado de |
| Q221 | varchar |  |  | SI | Datos de Contacto |
| Q222 | varchar |  |  | SI | Nombre Completo |
| Q223 | varchar |  |  | SI | Correo Electronico |
| Q224 | numeric |  |  | SI | Teléfono |
| Q225 | varchar |  |  | SI | Escala de carga del Cuidador Zarit |
| Q226 | varchar |  |  | SI | Escala de depresión geriátrica Yesavage |
| Q227 | varchar |  |  | SI | Escala de Lawton y Brody |
| Q228 | varchar |  |  | SI | Índice Barthel: |
| Q229 | varchar |  |  | SI | Escala Visual de Fragilidad |
| Q22a | varchar |  |  | SI | Otro Examen |
| Q230 | varchar |  |  | SI | Estado General |
| Q231 | varchar |  |  | SI | Circunferencia Pantorrilla Derecha |
| Q231ObsDR | varchar |  | FK | SI | Circunferencia Pantorrilla Derecha DR |
| Q232 | varchar |  |  | SI | Circunferencia Pantorrilla Izquierda |
| Q232ObsDR | varchar |  | FK | SI | Circunferencia Pantorrilla Izquierda DR |
| Q233 | varchar |  |  | SI | Fuerza de prensión manual (Dinamometría) |
| Q233ObsDR | varchar |  | FK | SI | Fuerza de prensión manual (Dinamometría) DR |
| Q234 | varchar |  |  | SI | Ha presentado Caídas |
| Q235 | varchar |  |  | SI | N° de Caídas |
| Q236 | varchar |  |  | SI | Rango de Tiempo |
