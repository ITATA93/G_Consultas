...
| Q02 | time | PK |  | SI | Hora |
| Q03 | varchar | PK |  | SI | Áreas del desempeño Ocupacional |
| Q04 | varchar | PK |  | SI | Patrones del Desempeño |
| Q05 | varchar | PK |  | SI | Motoras |
| Q06 | varchar | PK |  | SI | Observación |
| Q07 | varchar | PK |  | SI | Interacción y Comunicación |
| Q08 | varchar | PK |  | SI | Observación |
| Q09 | varchar | PK |  | SI | Funcionamiento Cognitivo |
| Q10 | varchar | PK |  | SI | Observación |
| Q11 | varchar | PK |  | SI | Situación Vital Actual |
| Q12 | varchar | PK |  | SI | Entorno Físico-Social |
| Q13 | varchar | PK |  | SI | Síntesis Diagnóstico Ocupacional |
