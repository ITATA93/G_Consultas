...
| Q02 | varchar | PK |  | SI | Diagnóstico Clínico |
| Q03 | varchar | PK |  | SI | Requerimiento |
| Q04 | varchar | PK |  | SI | Tipo de Cama |
| Q05 | varchar | PK |  | SI | Procedimiento: Especificar |
| Q06 | varchar | PK |  | SI | IQ: Especificar |
| Q07 | varchar | PK |  | SI | Informe Médico (Incluir exámenes) |
| Q08 | varchar | PK |  | SI | Nombre del paciente |
| Q09 | varchar | PK |  | SI | RUT Paciente |
| Q10 | varchar | PK |  | SI | Previsión FONASA |
| Q11 | varchar | PK |  | SI | Servicio |
| Q12 | date | PK |  | SI | Fecha de Ingreso |
| Q13 | varchar | PK |  | SI | Comuna |
| Q14 | varchar | PK |  | SI | Tipo de cama |
| Q15 | varchar | PK |  | SI | Hospital  |
| Q16 | varchar | PK |  | SI | Diagnostico 2 |
| Q17 | varchar | PK |  | SI | Diagnostico 3 |
