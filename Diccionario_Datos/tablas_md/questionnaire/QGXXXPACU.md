...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q13 | bit | PK |  | SI | Cooling Device |
| Q14 | varchar | PK |  | SI | Monitors Used |
| Q15 | varchar | PK |  | SI | Nurse's Notes |
| Q16 | varchar | PK |  | SI | Dressing Text |
| Q29 | varchar | PK |  | SI | Sedation Score |
| QQ10 | bit | PK |  | SI | Dressing Status |
| QQ11 | bit | PK |  | SI | Catheter checked |
| QQ12 | bit | PK |  | SI | Irrigation checked |
| QQ13 | bit | PK |  | SI | Mouth care given |
| QQ20 | varchar | PK |  | SI | Pulse |
| QQ22 | bit | PK |  | SI | Warming Blanket/Machine |
| QQ23 | bit | PK |  | SI | IV cannula removed |
| QQ25 | varchar | PK |  | SI | Pain Score |
| QQ3 | varchar | PK |  | SI | Initial Assessment |
| QQ6 | varchar | PK |  | SI | O2 administered litres/min: |
| QQ7 | varchar | PK |  | SI | Wound drainage on arrival |
