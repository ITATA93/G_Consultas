...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Nivel Educacional |
| Q02 | varchar | PK |  | SI | Años de Deserción |
| Q03 | varchar | PK |  | SI | Derivado Por |
| Q04 | varchar | PK |  | SI | Con Quien Vive |
| Q05 | varchar | PK |  | SI | Acompañado Por (Centros) |
| Q06 | varchar | PK |  | SI | Acompañado Por (Familia) |
| Q07 | varchar | PK |  | SI | Motivo de Consulta |
| Q08 | varchar | PK |  | SI | Resumen de Historia Reciente |
| Q09 | varchar | PK |  | SI | Tratamiento de Ingreso |
