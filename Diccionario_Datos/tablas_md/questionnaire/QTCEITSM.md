...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Trastornos del Humor |
| Q02 | varchar | PK |  | SI | Trastornos Mentales y del Comportamiento debido a ... |
| Q03 | bit | PK |  | SI | Trastorno de Ansiedad |
| Q04 | bit | PK |  | SI | Esquizofrenia |
| Q05 | bit | PK |  | SI | Trastornos de la Conducta Alimentaria |
| Q06 | bit | PK |  | SI | Trastorno Hopercinéticos de la Actividad y de la A... |
| Q07 | bit | PK |  | SI | Trastornos Emocionales y del Comportamiento de la ... |
| Q08 | bit | PK |  | SI | Retraso Mental |
| Q09 | bit | PK |  | SI | Trastorno de Personalidad |
| Q10 | bit | PK |  | SI | Trastorno Generalizados del Desarrollo |
