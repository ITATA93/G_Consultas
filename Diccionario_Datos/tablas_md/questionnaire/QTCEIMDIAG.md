...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Saludable |
| Q02 | varchar | PK |  | SI | Con factor de riesgo |
| Q03 | varchar | PK |  | SI | Con conducta de riesgo |
| Q04 | varchar | PK |  | SI | Con problema de salud |
| Q05 | varchar | PK |  | SI | Observación Adicional |
| Q06 | varchar | PK |  | SI | Observaciones Factores de Riesgo |
