...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Tipo Discapacidad Madre |
| Q02 | varchar | PK |  | SI | Escolaridad |
| Q03 | varchar | PK |  | SI | ¿Actualmente estudia en algún establecimiento educ... |
| Q04 | varchar | PK |  | SI | Nombre establecimiento |
| Q05 | date | PK |  | SI | Fecha Ingreso a Control Prenatal |
| Q06 | numeric | PK |  | SI | Edad Gestacional al Ingreso |
| Q07 | varchar | PK |  | SI | ¿Se entrega la guía para la Gestación y el Nacimie... |
| Q08 | varchar | PK |  | SI | Riesgo Psicosocial Abreviado |
| Q08ObsDR | varchar | PK | FK | SI | Riesgo Psicosocial Abreviado DR |
| Q09 | varchar | PK |  | SI | ¿Existe alguna situación de vulnerabilidad social ... |
| Q10 | varchar | PK |  | SI | Describa situación |
| Q11 | varchar | PK |  | SI | ¿Está de acuerdo con integrarse a Visita Domicilia... |
| Q12 | varchar | PK |  | SI | Evolución de la gestación |
| Q13 | varchar | PK |  | SI | ¿Quién la acompaña en la atención? |
