...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Examen Físico |
| Q02 | varchar | PK |  | SI | Piel, Mucosas y Fanereos |
| Q03 | varchar | PK |  | SI | Cabeza, Ojos, Oido,Nariz, Garganta |
| Q04 | varchar | PK |  | SI | Linfonodos |
| Q05 | varchar | PK |  | SI | Corazón |
| Q06 | varchar | PK |  | SI | Pulmonar |
| Q07 | varchar | PK |  | SI | Abdomen |
| Q08 | varchar | PK |  | SI | Mamas |
| Q09 | varchar | PK |  | SI | Neurologico |
| Q10 | varchar | PK |  | SI | General |
| Q11 | varchar | PK |  | SI | Genitales |
| Q12 | varchar | PK |  | SI | Rectal |
| Q13 | varchar | PK |  | SI | Estado Mental |
| Q14 | varchar | PK |  | SI | Comentarios |
| Q15 | varchar | PK |  | SI | Extremidades Superiores |
| Q20 | varchar | PK |  | SI | Extremidades Inferiores |
