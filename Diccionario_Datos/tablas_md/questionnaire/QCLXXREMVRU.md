...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | date | PK |  | SI | Fecha de Registro |
| Q02 | varchar | PK |  | SI | Tipo de Ronda |
| Q03 | numeric | PK |  | SI | N° de Rondas |
| Q04 | numeric | PK |  | SI | Médico |
| Q05 | numeric | PK |  | SI | Dentista |
| Q06 | numeric | PK |  | SI | Enfermera |
| Q07 | numeric | PK |  | SI | Matrona |
| Q08 | numeric | PK |  | SI | Nutricionista |
| Q09 | numeric | PK |  | SI | Tec. Paramédico |
| Q10 | numeric | PK |  | SI | Asistente Social |
| Q11 | numeric | PK |  | SI | Psicólogo |
| Q12 | numeric | PK |  | SI | Otros |
| Q13 | numeric | PK |  | SI | N° traslado de profesionales compra de servicio |
