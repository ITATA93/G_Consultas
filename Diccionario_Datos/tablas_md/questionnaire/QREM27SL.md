...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | AMBULANCIA TOTAL |
| Q02 | varchar | PK |  | SI | MARÍTIMO TOTAL |
| Q03 | varchar | PK |  | SI | AÉREO TOTAL |
| Q04 | varchar | PK |  | SI | AMBULANCIA A BENEFICIARIOS |
| Q05 | varchar | PK |  | SI | MARITIMO A BENEFICIARIOS |
| Q06 | varchar | PK |  | SI | AEREO A BENEFICIARIOS |
| Q07 | varchar | PK |  | SI | AMBULANCIA POR COMPRA DE SERVICIO |
| Q08 | varchar | PK |  | SI | MARITIMO POR COMPRA DE SERVICIO |
| Q09 | varchar | PK |  | SI | AEREO POR COMPRA DE SERVICIO |
