...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Control Prenatal |
| Q02 | date | PK |  | SI | Fecha 1° Control |
| Q03 | numeric | PK |  | SI | Semanas |
| Q04 | numeric | PK |  | SI | Peso |
| Q05 | date | PK |  | SI | Fecha último Control |
| Q06 | numeric | PK |  | SI | Semanas |
| Q07 | numeric | PK |  | SI | Peso |
| Q08 | numeric | PK |  | SI | N° de Controles |
| Q09 | varchar | PK |  | SI | Control DARO |
| Q10 | varchar | PK |  | SI | Anticoncepción |
| Q11 | varchar | PK |  | SI | Estado Nutrición |
| Q12 | numeric | PK |  | SI | Número Controles |
