...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Consentimiento Informado Completo |
| Q02 | varchar | PK |  | SI | Diagnóstico Quirúrgico |
| Q03 | varchar | PK |  | SI | Chequeo de Patologías Concomitantes |
| Q04 | varchar | PK |  | SI | Exámenes Pre Operatorios |
| Q05 | varchar | PK |  | SI | Ayuno |
| Q06 | varchar | PK |  | SI | Brazalete de Identificación  |
| Q07 | varchar | PK |  | SI | Chequeo de Medicamentos de Uso Habitual |
| Q08 | varchar | PK |  | SI | Profilaxis Antibiótica |
| Q09 | varchar | PK |  | SI | Preparación de la Piel |
| Q10 | bit | PK |  | SI | Marcaje de Sitio Quirúrgico (Si corresponde) |
| Q11 | varchar | PK |  | SI | VV permeable |
| Q12 | varchar | PK |  | SI | Retiro de Prótesis |
| Q13 | varchar | PK |  | SI | Medias Antiembólicas |
| Q14 | varchar | PK |  | SI | Retiro de Maquillaje/Joyas/Esmalte |
| Q15 | varchar | PK |  | SI | Chequeo de Infusiones/Drogas in Situ |
| Q16 | varchar | PK |  | SI | Ficha Clínica Física/Documentación/Exámenes |
| Q17 | varchar | PK |  | SI | Chequeo de Vaciamiento de Vejiga |
