...
|---------|------|----|----|----------|-------------|
| CQCCA5 | varchar | PK |  | SI | - |
| ID | bigint | PK |  | NO | - |
| QCCA1 | varchar | PK |  | SI | Ubicación del Accidente |
| QCCA2 | varchar | PK |  | SI | Mecanismo del Trauma |
| QCCA3 | varchar | PK |  | SI | Nº de Heridos |
| QCCA4 | varchar | PK |  | SI | Edad Estimada |
| QCCA5 | varchar | PK |  | SI | Sexo |
