...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q001 | varchar | PK |  | SI | Si se trata de un traumatismo: |
| Q002 | varchar | PK |  | SI | a) Se debe identificar la causa externa: |
| Q003 | varchar | PK |  | SI | b) Las circunstancias de la lesión, ségun estándar... |
| Q004 | varchar | PK |  | SI | c) Naturaleza de la lesión: |
| Q005 | varchar | PK |  | SI | d) Consignarlas en el registro que realiza: |
