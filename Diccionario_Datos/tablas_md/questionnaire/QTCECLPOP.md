...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Ficha Clínica  |
| Q02 | varchar | PK |  | SI | Indicaciones Médicas  |
| Q03 | varchar | PK |  | SI | Receta Médica |
| Q04 | varchar | PK |  | SI | Protocolo Operatorio  |
| Q05 | varchar | PK |  | SI | Consentimiento Informado Firmado  |
