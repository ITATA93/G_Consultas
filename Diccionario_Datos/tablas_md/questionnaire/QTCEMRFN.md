...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| QActivo | bit | PK |  | SI | Activo |
| QCTHospDateFrom | date | PK |  | SI | Inscripcion Desde |
| QCTHospDateTo | date | PK |  | SI | Inscripcion Hasta |
| QCTHospRef | varchar | PK |  | SI | Referencia a CTHospital |
| QDateFrom | date | PK |  | SI | DateFrom |
| QDateTo | date | PK |  | SI | Date To |
| QFamBoss | bit | PK |  | SI | Jefe de Familia |
| QFrmFrId | varchar | PK |  | SI | Id Cuestionario Riesgo |
| QFrmVivId | varchar | PK |  | SI | Id Cuestionario Vivienda |
| QMRFNro | varchar | PK |  | SI | Family Number |
| QRSRef | varchar | PK |  | SI | Referencia a Residence Status  |
