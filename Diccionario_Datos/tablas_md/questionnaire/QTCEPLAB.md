...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Ingreso a CRS-SAG |
| Q02 | varchar | PK |  | SI | Habilidades motoras |
| Q03 | varchar | PK |  | SI | Habilidades de procesamiento |
| Q04 | varchar | PK |  | SI | Habilidades de comunicacióne interacción |
| Q05 | varchar | PK |  | SI | Interes del usuario |
| Q06 | varchar | PK |  | SI | Según MOH y perfil laboral según AOTA |
