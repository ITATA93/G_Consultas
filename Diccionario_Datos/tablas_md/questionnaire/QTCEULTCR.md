...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Sistema Ventricular |
| Q02 | varchar | PK |  | SI | Parénquima Cerebral |
| Q03 | varchar | PK |  | SI | Cuerpo Calloso |
| Q04 | varchar | PK |  | SI | Núcleos Basales |
| Q05 | varchar | PK |  | SI | Territorio Silviano |
| Q06 | varchar | PK |  | SI | Fosa Posterior (hemisferios cerebelosos, vermis, c... |
| Q07 | varchar | PK |  | SI | Conclusión |
| Q08 | varchar | PK |  | SI | Indicaciones |
