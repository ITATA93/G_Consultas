...
|---------|------|----|----|----------|-------------|
| CQABC1 | varchar | PK |  | SI | - |
| ID | bigint | PK |  | NO | - |
| QABC1 | varchar | PK |  | SI | Permeabilidad Vía Aérea |
| QABC10 | varchar | PK |  | SI | Frecuencia Cardiaca |
| QABC11 | varchar | PK |  | SI | Presión Arterial |
| QABC12 | varchar | PK |  | SI | Pulsos Periféricos |
| QABC13 | varchar | PK |  | SI | Evaluación Llene Capilar |
| QABC14 | varchar | PK |  | SI | Perfisión Central |
| QABC2 | varchar | PK |  | SI | Frecuencia Respiratoria |
| QABC3 | bit | PK |  | SI | Estridor |
| QABC4 | bit | PK |  | SI | Musculatura Accesoria |
| QABC5 | bit | PK |  | SI | Aleteo Nasal |
| QABC6 | bit | PK |  | SI | Sonidos Respiratorios |
| QABC7 | bit | PK |  | SI | Estridor sibilancias |
| QABC8 | bit | PK |  | SI | Movimiento Paradojal |
| QABC9 | varchar | PK |  | SI | Color |
