...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Diagnóstico |
| Q02 | varchar | PK |  | SI | Métodos |
| Q03 | varchar | PK |  | SI | Epiglotis |
| Q04 | varchar | PK |  | SI | Otros Hallazgos naso-laríneos |
| Q05 | varchar | PK |  | SI | Árbol Bronquial |
| Q06 | varchar | PK |  | SI | Otros hallazos traqueo - bronquiales |
| Q07 | varchar | PK |  | SI | Eventos Adversos |
| Q08 | varchar | PK |  | SI | Conclusión |
| Q09 | varchar | PK |  | SI | Imagen |
