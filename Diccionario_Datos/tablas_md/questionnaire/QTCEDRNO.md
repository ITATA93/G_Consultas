...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Identificación con Brazalete Adecuado |
| Q02 | varchar | PK |  | SI | Aspiración Nasofaríngea |
| Q03 | varchar | PK |  | SI | Temperatura Rectal |
| Q03ObsDR | varchar | PK | FK | SI | Temperatura Rectal DR |
| Q04 | varchar | PK |  | SI | Profilaxis Ocular |
| Q05 | numeric | PK |  | SI | Número de Bebe |
