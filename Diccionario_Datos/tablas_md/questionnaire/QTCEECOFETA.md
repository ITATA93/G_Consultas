...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | date | PK |  | SI | F.U.R |
| Q02 | date | PK |  | SI | Fecha del Examen |
| Q03 | varchar | PK |  | SI | Edad Gestacional |
| Q04 | varchar | PK |  | SI | Causa de derivación |
| Q05 | varchar | PK |  | SI | Cuatro Cámaras |
| Q06 | varchar | PK |  | SI | Tracto de salida |
| Q07 | varchar | PK |  | SI | Aorta |
| Q08 | varchar | PK |  | SI | Ductus Arterioso |
| Q09 | varchar | PK |  | SI | Doppler intracardíaco |
| Q10 | varchar | PK |  | SI | Doppler Ductus Y vena UM |
| Q11 | varchar | PK |  | SI | Modo M |
| Q12 | varchar | PK |  | SI | Doppler art umbilical |
| Q13 | varchar | PK |  | SI | Otras Malformaciones |
| Q15 | varchar | PK |  | SI | Observaciones |
| Q16 | varchar | PK |  | SI | Conclusiones |
| QTRESVASOS | varchar | PK |  | SI | Tres Vasos |
