...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | ¿Este paciente tiene una amenaza real para su vida... |
| Q02 | varchar | PK |  | SI | ¿Es esta situación de alto riesgo?¿El paciente est... |
| Q03 | varchar | PK |  | SI | ¿Cuántos recursos diferentes se necesitan para la ... |
| Q04 | varchar | PK |  | SI | ¿Signos Vitales en zona de riesgo? |
| Q05 | varchar | PK |  | SI | ESI |
| Q06 | bit | PK |  | SI | Condición 1 |
| Q07 | bit | PK |  | SI | Condición 2 |
