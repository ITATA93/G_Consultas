...
|---------|------|----|----|----------|-------------|
| ID | bigint | PK |  | NO | - |
| Q01 | varchar | PK |  | SI | Hidrosonografía |
| Q02 | varchar | PK |  | SI | Grosor del endometrio |
| Q03 | varchar | PK |  | SI | Conclusión |
| Q038 | varchar | PK |  | SI | Hipótesis Diagnóstica |
| Q04 | varchar | PK |  | SI | Observaciones |
| Q048 | varchar | PK |  | SI | Observaciones |
| Q05 | varchar | PK |  | SI | Características Endometrio |
| QFECHAEXAMEN | date | PK |  | SI | Fecha Exámenes |
