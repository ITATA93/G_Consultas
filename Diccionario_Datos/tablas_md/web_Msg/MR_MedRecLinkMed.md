...
| MRLM_Childsub | double |  |  | SI | Childsub |
...
| MRLM_ParRef | varchar |  |  | SI | MR_Adm Parent Reference
...
| MRLM_RowId | varchar |  |  | SI | - |
| ReadOnly | bit |  |  | SI | - |
| SessionId | varchar |  |  | SI | - |
| childsub | bigint |  |  | NO | - |
| webMsgClassName | varchar |  |  | SI | - |
| web_Msg_MRLM_ParRef | varchar |  |  | SI | - |
