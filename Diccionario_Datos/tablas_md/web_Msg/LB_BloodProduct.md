...
| BulkUpdateError | varchar |  |  | SI | - |
| BulkUpdateErrorAcknowledged | bit |  |  | SI | If the record is submitted with this as true, it m... |
| Hidden | bit |  |  | SI | Boolean indicating if message entry is hidden from... |
| ID | varchar |  |  | NO | - |
...
| LBBP_BloodProduct_DR | bigint |  | FK | SI | Product Code
Required by User.LBBloodProduct. |
...
| LBBP_ExpiryDate | date |  |  | SI | Expiry Date
Required by User.LBBloodProduct. |
| LBBP_ExpiryTime | time |  |  | SI | Expiry Time
Required by User.LBBloodProduct. |
...
| LBBP_RowID | varchar |  |  | SI | - |
| LBBP_Source_DR | bigint |  | FK | SI | Source
Required by User.LBBloodProduct. |
...
| LBBP_UnitNumber | varchar |  |  | SI | Unit / Donation Number
Required by User.LBBloodPr... |
