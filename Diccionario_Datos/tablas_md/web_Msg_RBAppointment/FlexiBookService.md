# web_Msg_RBAppointment.FlexiBookService
...
| MaxWeeksAfterOnset | integer |  |  | SI | - |
| MinWeeksAfterOnset | integer |  |  | SI | - |
...
| RoomDR | bigint |  | FK | SI | - |
| SSDaysMax | numeric |  |  | SI | - |
| SSDaysMin | numeric |  |  | SI | - |
| SSHoursMax | numeric |  |  | SI | - |
| SSHoursMin | numeric |  |  | SI | - |
| SSMain | varchar |  |  | SI | - |
| SSMinutesMax | numeric |  |  | SI | - |
| SSMinutesMin | numeric |  |  | SI | - |
